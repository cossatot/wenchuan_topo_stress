...
%            bookmarks=true,
%            pdfauthor={},
%            pdftitle={Topographic stresses and the Wenchuan earthquake},
%            colorlinks=true,
%            citecolor=blue,
%            urlcolor=blue,
%            linkcolor=magenta,
...
\begin{figure*}[ht!]
\includegraphics[width=40pc]{../figures/lms_map.pdf}
...
Our results indicating that topographic stresses on the Wenchuan
earthquake faults are largely loaded in the opposite sense to the
coseismic slip direction shows that gravitational collapse is probably
...
orientation from fault (or rangefront) normal to closer to more oblique
...
channels are present, and are very weak so shear can occur at relatively
...
calculations of $\mu$ and $\phi$ are based on $T$, which is weighted
...
though $\phi$ may be higher there. Similarly, a low viscosity horizontal
...
This is all quite speculative, and we wish only to describe the
