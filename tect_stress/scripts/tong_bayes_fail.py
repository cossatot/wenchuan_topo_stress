...
outfile = '../results/tong_fail_posteriors.csv'
t_poster_file = '../results/tong_tect_posteriors.csv'

lms = pd.read_csv('../../slip_models/tong/tong_topo_stress.csv')
...
lms_copy_cols = ['z', 'strike','dip','net_slip', 
